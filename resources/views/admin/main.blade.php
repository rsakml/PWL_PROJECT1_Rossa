                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-xs-9">
                        ...
                        <div class="small-box bg-green">
                            <div class="inner">
                                <h3>{{$count2}}<sup style="font-size: 20px"></sup></h3>
                    ...
                    <section class="col-lg-7 connectedSortable">
                        ...
                        <div class="box box-success">
                            ...
                            <div class="box-body chat" id="chat-box">
                                <!-- chat item -->
                                <div class="item">
                                    <img src="{{ asset('AdminLTE-2/dist/img/user4-128x128.jpg') }}" alt="user image"
                                        class="online">
                                ...
                                <!-- chat item -->
                                <div class="item">
                                    <img src="{{ asset('AdminLTE-2/dist/img/user3-128x128.jpg') }}" alt="user image"
                                        class="offline">
